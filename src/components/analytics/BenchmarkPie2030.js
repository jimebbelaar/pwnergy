...
class BenchmarkPie2030 extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (
      <Card small className="ubd-stats mb-4">
...
export default BenchmarkPie2030;
