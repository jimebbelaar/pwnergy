!function () {
  ...
  function Ie(n, t, e, r) {
    ...
    return function (a) {
      ...
      var v, d, m, y, M, x, b, _, w, S, k, E = a, A = Re(), N = Oe(n, t, e, r),
        C = {
  ...
  function ir(n) {
    ...
    var i, o, a, c, l, s, f = nr(function (n, t) {
      ...
      }), h = 150, g = 480, p = 250, v = 0, d = 0, m = 0, M = 0, x = 0, b = Lc,
      _ = y, w = null, S = null;
  ...
  function Mr(n, t, e, r) {
    var u = Math.cos(t), i = Math.sin(t), o = Math.cos(r), a = Math.sin(r),
      ...
      g = 1 / Math.sin(h), p = h ? function (n) {
        var t = Math.sin(n *= h) * g, e = Math.sin(h - n) * g, r = e * c + t * s,
          u = e * l + t * f, o = e * i + t * a;
  ...
  function Br(n, t) {
    ...
    var r, u, i = n.a, o = t[0][0], a = t[1][0], c = t[0][1], l = t[1][1],
      s = n.l, f = n.r, h = s.x, g = s.y, p = f.x, v = f.y, d = (h + p) / 2,
      m = (g + v) / 2;
    if (v === g) {
      if (o > d || d >= a) return;
      if (h > p) {
  ...
  function Hu(n, t) {
    var e, r = [], u = [], i = ta.transform(n), o = ta.transform(t),
      a = i.translate, c = o.translate, l = i.rotate, s = o.rotate, f = i.skew,
      h = o.skew, g = i.scale, p = o.scale;
  ...
  function Vi(n, t) {
    ...
    var e = Pi(n), r = e[1] - e[0],
      u = Math.pow(10, Math.floor(Math.log(r / t) / Math.LN10)), i = t / r * u;
    ...
    function e(n, t, e, i, o) {
      return function () {
        ...
        var l, s = this, f = ta.event.target, h = s.parentNode,
          ...
          d = ".drag" + (null == v ? "" : "-" + v),
          m = ta.select(e(f)).on(i + d, a).on(o + d, c), y = W(f), M = t(h, v);
  ...
  var Ca = 1e-6, za = Ca * Ca, qa = Math.PI, La = 2 * qa, Ta = La - Ca,
    Ra = qa / 2, Da = qa / 180, Pa = 180 / qa, Ua = Math.SQRT2, ja = 2, Fa = 4;
  ta.interpolateZoom = function (n, t) {
    ...
    var v, d, m, y, M, x, b, _, w, k = {x: 0, y: 0, k: 1}, A = [960, 500],
      N = Ia, C = 250, z = 0, q = "mousedown.zoom", L = "mousemove.zoom",
      T = "mouseup.zoom", R = "touchstart.zoom",
  ...
  ta.interpolateTransform = Hu, ta.layout = {}, ta.layout.bundle = function () {
    ...
    var e, r, u, i, o, a = {}, c = ta.dispatch("start", "tick", "end"),
      l = [1, 1], s = .9, f = fl, h = hl, g = -30, p = gl, v = .1, d = .64,
      m = [], M = [];
  ...
  ta.layout.hierarchy = function () {
    ...
    function n(o) {
      var a, c = o.length, l = o.map(function (e, r) {
        ...
        g = h * (0 > f ? -1 : 1), p = (f - c * g) / ta.sum(l), v = ta.range(c),
        d = [];
    ...
    function n(n) {
      n.each(function () {
        ...
        var w, S, k, E, A = v.select("line"), N = m.select("line"),
          ...
          q = m.select("text"), L = "top" === r || "left" === r ? -1 : 1;
